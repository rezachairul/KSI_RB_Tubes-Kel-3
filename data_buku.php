...
<body>
        ...
        <section class="main m-3">
            <h2 class="judul mb-4">Data Buku</h2>
            <a href="data_buku_tambah.php"><button type="button" class="btn btn-primary">Tambah</button></a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $ambil_data['judul_buku']; ?></td>
                        <td><?php echo $ambil_data['id_penulis']; ?></td>
                        <td><?php echo $ambil_data['id_kategori']; ?></td>
                        <td><?php echo $ambil_data['tahun_buku']; ?></td>
                        <td><?php echo $ambil_data['isbn_buku']; ?></td>
                        <td><?php echo $ambil_data['sinopsis']; ?></td>
                        <td><?php echo $ambil_data['jumlah']; ?></td>
                        <td>
                            <a href="data_buku_edit.php?id=<?php echo $ambil_data['id_buku']; ?>"><button type="button" class="btn btn-success" value="update">Edit</button></a>
                            <a href="data_buku_hapus.php?id=<?php echo $ambil_data['id_buku']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                        </td>
